...
public class MyRVAdapter extends RecyclerView.Adapter<MyRVAdapter.MyHolder>{
    ...
    public MyRVAdapter(List<Student> stut_list, Context contexts) {
        this.student_list = stut_list;
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        final  Student stu = student_list.get(position);
...
//            holder.imageview.setImageDrawable(context.getResources().getDrawable(R.drawable.man));
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Student studen=student_list.get(position);
                ...
                notifyItemRangeChanged(position,student_list.size());
